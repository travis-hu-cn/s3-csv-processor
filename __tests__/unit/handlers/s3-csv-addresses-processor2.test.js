...
const INVALID_4TH_LINE = `latitude,longitude,address
...
describe('Test csvAddressesHandler', function () { 
  ...
  it('TEST CASE 2:', async () => {
    ...
    const objectBody = INVALID_4TH_LINE;
    const getObjectResp = {
      Body: objectBody
    };
    ...
    expect(console.error).toHaveBeenCalledWith('Invalid format at line 4 of file addresses.csv');
